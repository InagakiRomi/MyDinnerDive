...
CREATE TABLE IF NOT EXISTS restaurants (
    restaurant_id    INT GENERATED BY DEFAULT AS IDENTITY (START WITH 51) PRIMARY KEY,     -- 餐廳編號，自動遞增，主鍵
...
(
    user_id            INT GENERATED BY DEFAULT AS IDENTITY (START WITH 30) PRIMARY KEY,
