...
public class UserDaoImpl implements UserDao{
    ...
    public User getUserById(Integer userId){
        String sql = "SELECT user_id, account, password, created_date, last_modified_date " +
    ...
    String sql = "INSERT INTO users (account, password, created_date, last_modified_date) " +
                 "VALUES (:account, :password, :createdDate, :lastModifiedDate)";
