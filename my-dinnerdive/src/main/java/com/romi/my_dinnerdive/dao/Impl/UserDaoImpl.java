...
public class UserDaoImpl implements UserDao{
    ...
    public User getUserById(Integer userId){
        String sql = "SELECT user_id, username, member_password, roles, created_date, last_modified_date " +
    ...
    String sql = "INSERT INTO users (username, member_password, roles, created_date, last_modified_date) " +
                 "VALUES (:username, :memberPassword, :roles, :createdDate, :lastModifiedDate)";
